...
public:
/**
 * @brief Virtual default destructor to allow proper cleanup in derived classes.
 *
 * Ensures that destruction through a base-class pointer invokes derived-class destructors.
 */
